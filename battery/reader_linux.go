...
func (r *LinuxReader) ReadInt(filename string) (int64, error) {
...
func (r *LinuxReader) ReadString(filename string) (string, error) {
	data, err := os.ReadFile(filepath.Join(r.path, filename))
	if err != nil {
		return "", err
	}
...
func (r *LinuxReader) ReadInfo() (*BatteryInfo, error) {
